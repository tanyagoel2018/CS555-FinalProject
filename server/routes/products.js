...
import {purchaseProduct, getPurchasableProducts, getMyProducts, updateOutfit} from "../controllers/products.js"
const router = Router();
...
router.route("/myProducts").get(getMyProducts).post(updateOutfit);
